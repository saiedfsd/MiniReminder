...
class _AddEditReminderScreenState extends State<AddEditReminderScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.reminderId != null) _fetchReminder();
  }
                ...
                children: [
                  ...
                  _buildInputCard(
                    ...
                    child: DropdownButtonFormField(
                        ...
                        items: ["Work", "Personal", "Helps", "Others"].map((category) {
  ...
  Widget _buildDateTimerPicker({
    required String label, required IconData icon, required String displayValue, required Function() onPressed
  }) {
    return Card(
      elevation: 6,
      color: Colors.teal.shade50,
      ...
      child: ListTile(
        ...
        trailing: TextButton(onPressed: onPressed, child: Text(
          displayValue,
