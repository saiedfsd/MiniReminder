...
import 'package:mini_reminder/screens/add_reminder/add_edit_reminder_screen.dart';
    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(backgroundColor: Colors.white, title: Text("Reminder Details"), centerTitle: true),
          body: Padding(
